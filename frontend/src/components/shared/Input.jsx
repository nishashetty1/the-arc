    ...
    <div className={clsx(
      ...
      {label && (
        <label 
          htmlFor={generatedId}
          className={clsx(
            "block mb-1.5 text-sm font-medium text-white",
      ...
      <div className="relative">
        ...
        <input
          ...
          className={clsx(
            "block w-full rounded-lg border border-neutral-300 bg-white text-black px-4 focus:border-primary-500 focus:ring-1 focus:ring-primary-500 outline-none transition-all",
            sizeClasses[size],
